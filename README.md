...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/docker-buildx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/docker-buildx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add docker-buildx
# for installing globally
pixi global install docker-buildx
```
...
It is possible to list all of the versions of `docker-buildx` available on your platform:
...
```
pixi search docker-buildx --channel conda-forge
```
